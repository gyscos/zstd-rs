...
pub struct ZSTD_Sequence {
    pub matchPos: ::std::os::raw::c_uint,
...
extern "C" {
    #[doc = " ZSTD_estimate*() :"]
    #[doc = "  These functions make it possible to estimate memory usage of a future"]
    #[doc = "  {D,C}Ctx, before its creation."]
    #[doc = ""]
    #[doc = "  ZSTD_estimateCCtxSize() will provide a budget large enough for any"]
    #[doc = "  compression level up to selected one. Unlike ZSTD_estimateCStreamSize*(),"]
    #[doc = "  this estimate does not include space for a window buffer, so this estimate"]
    #[doc = "  is guaranteed to be enough for single-shot compressions, but not streaming"]
    #[doc = "  compressions. It will however assume the input may be arbitrarily large,"]
    #[doc = "  which is the worst case. If srcSize is known to always be small,"]
    #[doc = "  ZSTD_estimateCCtxSize_usingCParams() can provide a tighter estimation."]
    #[doc = "  ZSTD_estimateCCtxSize_usingCParams() can be used in tandem with"]
    #[doc = "  ZSTD_getCParams() to create cParams from compressionLevel."]
    #[doc = "  ZSTD_estimateCCtxSize_usingCCtxParams() can be used in tandem with"]
    #[doc = "  ZSTD_CCtxParams_setParameter()."]
    #[doc = ""]
    #[doc = "  Note: only single-threaded compression is supported. This function will"]
    #[doc = "  return an error code if ZSTD_c_nbWorkers is >= 1."]
