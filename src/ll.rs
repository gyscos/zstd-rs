...
extern "C" {
    ...
    pub fn ZSTD_compress(dst: *mut u8, dstCapacity: size_t,
                         src: *const u8, srcSize: size_t,
                         compressionLevel: ::libc::c_int) -> size_t;
    pub fn ZSTD_getDecompressedSize(src: *const u8,
                                    srcSize: size_t) -> ::libc::c_ulonglong;
    pub fn ZSTD_decompress(dst: *mut u8, dstCapacity: size_t,
                           src: *const u8, compressedSize: size_t)
     -> size_t;
    ...
    pub fn ZSTD_createCCtx_advanced(customMem: ZSTD_customMem)
     -> *mut ZSTD_CCtx;
    pub fn ZSTD_createCDict_advanced(dict: *const u8,
                                     dictSize: size_t,
    ...
    pub fn ZSTD_flushStream(zcs: *mut ZSTD_CStream,
                            output: *mut ZSTD_outBuffer) -> size_t;
    ...
    pub fn ZDICT_trainFromBuffer(dictBuffer: *mut u8, dictBufferCapacity: size_t,
